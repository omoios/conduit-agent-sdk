...
class SessionUpdate:
    ...
    tool_locations: str | None
    mode_id: str | None
    plan_json: str | None
    config_json: str | None
    commands_json: str | None
    usage_json: str | None
    session_info_json: str | None
    ...
    def __init__(
        ...
        tool_locations: str | None = None,
        mode_id: str | None = None,
        plan_json: str | None = None,
        config_json: str | None = None,
        commands_json: str | None = None,
        usage_json: str | None = None,
        session_info_json: str | None = None,
...
class RustClient:
    ...
    async def new_session(
        self, cwd: str | None = None, meta_json: str | None = None, mcp_servers_json: str | None = None
    ) -> str: ...
    ...
    async def list_sessions(self, cwd: str | None = None) -> str: ...
    ...
    async def recv_update(self) -> SessionUpdate | None: ...
    async def capabilities(self) -> Capabilities | None: ...
    async def agent_info(self) -> str | None: ...
